...
const ExplainEngine = () => {
    ...
    const handleExport = () => {
        ...
        generatePDF(outputRef.current, levels[level].label);
    };
    ...
    return (
        <div className="w-full max-w-4xl mx-auto space-y-8 sm:space-y-12 relative px-4 sm:px-0">
            ...
            <footer className="text-center pt-12 pb-8 text-xs text-zinc-600 flex items-center justify-center gap-2">
                ...
                <a href="https://github.com/Dsp023" target="_blank" rel="noopener noreferrer" className="hover:text-zinc-400 transition-colors" aria-label="GitHub Profile">
